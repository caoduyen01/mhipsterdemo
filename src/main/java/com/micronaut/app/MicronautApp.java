package com.micronaut.app;

import com.micronaut.app.config.DefaultProfileUtil;
...
public class MicronautApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(MicronautApp.class);

    /**
     * Initializes MicronautApp.
     * <p>
