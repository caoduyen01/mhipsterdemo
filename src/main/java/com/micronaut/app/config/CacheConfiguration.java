package com.micronaut.app.config;

import java.net.URI;
import java.net.URISyntaxException;
import java.util.Properties;

import com.micronaut.app.util.JHipsterProperties;
...
public class CacheConfiguration {
    ...
    private void customizeCacheManager(CacheManager cm) {
        createCache(cm, com.micronaut.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
        createCache(cm, com.micronaut.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
        createCache(cm, com.micronaut.app.domain.User.class.getName());
        createCache(cm, com.micronaut.app.domain.Authority.class.getName());
        createCache(cm, com.micronaut.app.domain.User.class.getName() + ".authorities");
