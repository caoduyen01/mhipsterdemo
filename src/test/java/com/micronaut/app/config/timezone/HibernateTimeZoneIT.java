package com.micronaut.app.config.timezone;

import com.micronaut.app.RedisTestContainerExtension;
import com.micronaut.app.MicronautApp;
import com.micronaut.app.repository.timezone.DateTimeWrapper;
import com.micronaut.app.repository.timezone.DateTimeWrapperRepository;
...
@MicronautTest(application = MicronautApp.class, environments = {"test"})
